...
$headers .= "From: Confirmation d'inscription  <webmaster@e-service-madagascar.com>\n";
$headers .= "Reply-To: No Reply <webmaster@e-service-madagascar.com>\n";
                                                                ...
                                                                <td align="right" valign="middle" class="flexibleContainerBox">
                                                                        <tr>
                                                                            <td align="left" class="textContent">
                                                                                <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Bonjour <b>' . $_POST['prenom']. ' </b>,</h3>
                                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                    Merci de votre inscription sur  !<br/><br/>
                                                                                    Afin de pouvoir vous connecter, nous vous invitons  a utilise le code de confirmation suivant.<br/><br/>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                ...
                                                                                -->
                                                                                <h3 mc:edit="header"
                                                                                 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Copyright © 2018, e-service-madagascar.com - Tous droits réservés </h3>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <!-- // CONTENT TABLE -->
...
mail($_POST['email'], "Confirmation d'inscription", $messageM, $headers);
